...
$newUrl = "/admin/levels/edit/";
$deleteUrl = "/admin/levels/delete/";
$changeSecretUrl = "/admin/levels/changesecret/";
$detailUrl = "/admin/levels/detail/";
$uploadFormUrl = "/admin/levels/uploadform/";
$title = "Overzicht gebruikers";
require __DOCUMENTROOT__ . '/views/admin/levels/edit.php';